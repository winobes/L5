...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &tutorial__person__descriptor);
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &tutorial__address_book__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Tutorial__Person__PhoneNumber, number),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(Tutorial__Person__PhoneNumber, has_type),
    PROTOBUF_C_OFFSETOF(Tutorial__Person__PhoneNumber, type),
...
const ProtobufCEnumValue tutorial__person__phone_type__enum_values_by_number[3] =
{
...
const ProtobufCEnumValueIndex tutorial__person__phone_type__enum_values_by_name[3] =
{
  { "HOME", 1 },
  { "MOBILE", 0 },
  { "WORK", 2 },
...
{
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Tutorial__Person, name),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Tutorial__Person, id),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Tutorial__Person, email),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(Tutorial__Person, n_phone),
    PROTOBUF_C_OFFSETOF(Tutorial__Person, phone),
...
{
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(Tutorial__AddressBook, n_person),
    PROTOBUF_C_OFFSETOF(Tutorial__AddressBook, person),
