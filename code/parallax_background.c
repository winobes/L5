if (gs->current_room == 0) {
	...
	al_draw_bitmap(background1,
					-parallax1_rate*(player->cx-room[0]->w/2) + parallax1_x1*width,
					-parallax1_rate*(player->cy-room[0]->h/2) + parallax1_y1*height,
					0);

	al_draw_bitmap(background1,
					-parallax1_rate*(player->cx-room[0]->w/2) + parallax1_x2*width,
					-parallax1_rate*(player->cy-room[0]->h/2) + parallax1_y2*height,
					0);
	...
	al_draw_bitmap(background2,
					-parallax2_rate*(player->cx-room[0]->w/2) + 0*width,
					-parallax2_rate*(player->cy-room[0]->h/2) + 0*height,
					0);
	...
	al_draw_bitmap(background3,
					-parallax3_rate*(player->cx-room[0]->w/2) + parallax3_x1*width,
					-parallax3_rate*(player->cy-room[0]->h/2) + parallax3_y1*height,
					0);

	al_draw_bitmap(background3,
					-parallax3_rate*(player->cx-room[0]->w/2) + parallax3_x2*width,
					-parallax3_rate*(player->cy-room[0]->h/2) + parallax3_y2*height,
					0);
